...
int main() {
  ...
  std::string dir = DIR;
  std::string file = dir + "Density 0.5/Isothermal~step 5000";
  std::vector<int> p = { 6, 8/*, 10, 12 */};
  std::vector<int> p2 = { 10, 12 };
  std::vector<double> A1 = { 0/*, 0.25, 0.50, 0.65, 0.7, 0.75, 0.8, 0.85*/ };
  std::vector<double> A2 = { 0/*, 0.90, 1.00, 1.05, 1.1, 1.2, 1.25, 1.50*/ };
  ...
  for (size_t i = 0; i < p.size(); i++) {
    for (size_t j = 0; j < A1.size(); j++) {
      ...
      std::thread th(&MD::Simulation, run2, p2[i], A2[j]);
