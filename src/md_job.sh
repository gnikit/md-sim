...
# Compile
icpc -pthread -parallel -mkl=parallel -O3 -xHOST -std=c++17 -use-intel-optimized-headers -daal -tbb -m64 -prec-sqrt -prec-div -qopt-multi-version-aggressive -qopt-matmul MD.cpp Source.cpp -o a.out
# Run
./a.out
